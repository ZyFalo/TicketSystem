# ticket-assignments Specification

## Purpose
Define la asignación múltiple de responsables a tickets, los requisitos para transiciones de estado basados en asignaciones y el historial de cambios de asignación.
